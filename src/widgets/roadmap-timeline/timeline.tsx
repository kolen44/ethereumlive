...
export default function CreateTimeline(){
	return(
		<Box width='100%' height='auto' p='50px 0' backgroundColor='#141214' display='grid' justifyItems='center' borderRadius='15px'>
			<Text fontSize={['3rem','3rem','4rem']} marginBottom='80px' className='roadmap-timeline-header' fontWeight='bold' color='rgb(106,6,236)' position='relative'>
				Roadmap
			</Text>
			<Box className='box-container' w='70%' h='auto' position='relative'>
				<List  color='black'>
					<ListItem className='roadmap-timeline-list-item'>
						<Heading fontSize={['2rem','3rem','4rem']}>The first beta test</Heading>
